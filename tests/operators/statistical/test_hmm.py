...
class TestHMMConfig:
    ...
    def test_default_config(self):
        ...
        assert config.num_emissions == 4  # DNA alphabet
    ...
    def test_custom_states(self):
        ...
        config = HMMConfig(num_states=5)
        assert config.num_states == 5

    def test_custom_emissions(self):
        """Test custom number of emissions."""
        config = HMMConfig(num_emissions=20)  # Amino acids
        assert config.num_emissions == 20
...
class TestDifferentiableHMM:
    ...
    def test_apply_returns_state_posteriors(self, rngs, integer_observations):
        ...
        # Shape should be (seq_len, num_states)
...
class TestGradientFlow:
    ...
    def test_transitions_are_learnable(self, rngs):
        ...
        config = HMMConfig(num_states=3, num_emissions=4, learnable_transitions=True)
        op = DifferentiableHMM(config, rngs=rngs)
    ...
    def test_emissions_are_learnable(self, rngs):
        ...
        config = HMMConfig(num_states=3, num_emissions=4, learnable_emissions=True)
        op = DifferentiableHMM(config, rngs=rngs)
...
class TestEdgeCases:
    ...
    def test_two_states(self, rngs):
        ...
        config = HMMConfig(num_states=2, num_emissions=4)
        op = DifferentiableHMM(config, rngs=rngs)
    ...
    def test_many_states(self, rngs):
        ...
        config = HMMConfig(num_states=10, num_emissions=4)
        op = DifferentiableHMM(config, rngs=rngs)
    ...
    def test_high_temperature(self, rngs):
        ...
        config = HMMConfig(num_states=3, num_emissions=4, temperature=10.0)
        op = DifferentiableHMM(config, rngs=rngs)
    ...
    def test_low_temperature(self, rngs):
        ...
        config = HMMConfig(num_states=3, num_emissions=4, temperature=0.1)
        op = DifferentiableHMM(config, rngs=rngs)
