...
class TestSplitterModuleBase:
    ...
    def test_split_method_abstract(self):
        ...
        with pytest.raises(NotImplementedError):
            splitter.split(None)  # pyright: ignore[reportArgumentType]
...
class TestSplitterCreateSplitSources:
    ...
    def test_create_split_sources_eager(self, mock_data_source):
        ...
        assert isinstance(train_src, MemorySource)  # pyright: ignore[reportArgumentType]
        assert isinstance(valid_src, MemorySource)  # pyright: ignore[reportArgumentType]
        assert isinstance(test_src, MemorySource)  # pyright: ignore[reportArgumentType]
