...
class TestStVariants:
    ...
    ST_NAMES = [
        "abs_st", "argmax_st", "argmedian_st", "argmin_st",
        "argpercentile_st", "argquantile_st", "argsort_st",
        "clip_st", "equal_st", "greater_equal_st", "greater_st",
        "heaviside_st", "isclose_st", "less_equal_st", "less_st",
        "max_st", "median_st", "min_st", "not_equal_st",
        "percentile_st", "quantile_st", "rank_st", "relu_st",
        "round_st", "sign_st", "sort_st", "top_k_st",
    ]
