...
reproduced by a documented script under \texttt{benchmarks/crossmodality/}.
...
for its leak-free audit; and disjoint \emph{genomic regions} for variant calling
(chr20:2--22\,Mb train, 30--40\,Mb test). Where an experiment reports a validation set, it is
