...
Normalization & VAE normalizer, UMAP, PHATE, learnable projection, soft-$k$ & power, sigmoid \\
...
random-projection and no-reduction control. \emph{Fully differentiable PCA:} replace the
fixed anchor with a backpropagation-friendly power-iteration
eigensolver~\citep{wang2019backprop} to make the basis itself trainable while retaining
stability. \emph{Deepen the cross-modality results:} with scATAC now characterized in depth (scaling,
